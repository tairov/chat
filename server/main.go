...
import (
	...
	_ "github.com/tairov/chat/server/auth/anon"
	_ "github.com/tairov/chat/server/auth/basic"
	_ "github.com/tairov/chat/server/auth/rest"
	_ "github.com/tairov/chat/server/auth/token"

	// Database backends
	_ "github.com/tairov/chat/server/db/mongodb"
	_ "github.com/tairov/chat/server/db/mysql"
	_ "github.com/tairov/chat/server/db/rethinkdb"

	// Push notifications
	"github.com/tairov/chat/server/push"
	_ "github.com/tairov/chat/server/push/fcm"
	_ "github.com/tairov/chat/server/push/stdout"
	_ "github.com/tairov/chat/server/push/tnpg"

	"github.com/tairov/chat/server/store"

	// Credential validators
	_ "github.com/tairov/chat/server/validate/email"
	_ "github.com/tairov/chat/server/validate/tel"
	"google.golang.org/grpc"

	// File upload handlers
	_ "github.com/tairov/chat/server/media/fs"
	_ "github.com/tairov/chat/server/media/s3"
)
